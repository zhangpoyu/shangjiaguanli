						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="xiugaishangjiaact.action" enctype="multipart/form-data">
										<div class="card-body">
											<input name='id' style='display:none;' value="${shangjia.id}"><div class="form-group row">
												<label class="col-sm-3 col-form-label">名字</label>
												<div class="col-sm-9">
													<input name="mingzi" value="${shangjia.mingzi}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">账号</label>
												<div class="col-sm-9">
													<input readonly name="username" value="${shangjia.username}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">密码</label>
												<div class="col-sm-9">
													<input name="password" value="${shangjia.password}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">商家地址</label>
												<div class="col-sm-9">
													<input name="shangjiadizhi" value="${shangjia.shangjiadizhi}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">联系方式</label>
												<div class="col-sm-9">
													<input name="lianxifangshi" value="${shangjia.lianxifangshi}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">审核</label>
												<div class="col-sm-9">
													<input name="shenhe" value="${shangjia.shenhe}" type="text" class="form-control" placeholder=" ">
												</div>
											</div>
										</div>
