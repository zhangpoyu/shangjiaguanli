						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="yonghuxiugaigouwucheact.action" enctype="multipart/form-data">
										<div class="card-body">
											<input name='id' style='display:none;' value="${gouwuche.id}"><div class="form-group row">
...
<script>
                                           ...
                                           $("#shangpingid").val($("#shangpingid option:eq("+select.selectedIndex+")").val());                                                	}
												...
												<div class="col-sm-9">
													<input name="shuliang" value="${gouwuche.shuliang}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
