						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="xiugaishangpingact.action" enctype="multipart/form-data">
										<div class="card-body">
											<input name='id' style='display:none;' value="${shangping.id}"><div class="form-group row">
												<label class="col-sm-3 col-form-label">商品名字</label>
												<div class="col-sm-9">
													<input name="shangping" value="${shangping.shangping}" type="text" class="form-control" placeholder=" ">
												</div>
...
<script>
                                           ...
                                           $("#leixingid").val($("#leixingid option:eq("+select.selectedIndex+")").val());                                                	}
												...
												<div class="col-sm-9">
													<input name="miaoshu" value="${shangping.miaoshu}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">价格</label>
												<div class="col-sm-9">
													<input name="jiage" value="${shangping.jiage}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">数量</label>
												<div class="col-sm-9">
													<input name="shuliang" value="${shangping.shuliang}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">商家</label>
												<div class="col-sm-9">
													<input name="shangjia" value="${shangping.shangjia}" type="text" class="form-control" placeholder=" ">
												</div>
												...
												<div style='display:none;' class="col-sm-9">
													<input name="shangjiaid" value="${shangping.shangjiaid}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">图片</label>
												<div class="col-sm-9">
													<input name="tupian" value="${shangping.tupian}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">简介</label>
												<div class="col-sm-9">
													<input name="jianjie" value="${shangping.jianjie}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">下单次数</label>
												<div class="col-sm-9">
													<input name="xdcs" value="${shangping.xdcs}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">浏览次数</label>
												<div class="col-sm-9">
													<input name="llcs" value="${shangping.llcs}" type="text" class="form-control" placeholder=" ">
												</div>
											</div>
										</div>
