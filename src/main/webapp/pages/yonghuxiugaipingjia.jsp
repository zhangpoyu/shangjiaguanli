						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="yonghuxiugaipingjiaact.action" enctype="multipart/form-data">
										<div class="card-body">
											<input name='id' style='display:none;' value="${pingjia.id}"><div class="form-group row">
												<label class="col-sm-3 col-form-label">评论</label>
												<div class="col-sm-9">
													<input name="neirong" value="${pingjia.neirong}" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">评价</label>
												<div class="col-sm-9">
													<input name="pingjia" value="${pingjia.pingjia}" type="text" class="form-control" placeholder=" ">
												</div>
