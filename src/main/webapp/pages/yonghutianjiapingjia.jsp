						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="yonghutianjiapingjiaact.action" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group row">
												<label class="col-sm-3 col-form-label">评论</label>
												<div class="col-sm-9">
													<input name="neirong" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">评价</label>
												<div class="col-sm-9">
													<select name="pingjia" type="text" class="form-control">
														<option>好评</option>
														<option>中评</option>
														<option>差评</option>
													</select>
										...
										function GetQueryString(name) { 
											...
											　　$("#shangpingid").val(shangpingid);
											   ...
											   $("#shangping").attr("disabled","disabled");
												...
												<div class="col-sm-9">
                                                    <select id='shangjia' onchange="shangjiachange(this)"name="shanghu" class="form-control"><c:if test="${ !empty shangjiaall}">
										...
										function GetQueryString(name) { 
											...
											　　$("#shangjiaid").val(shangjiaid);
											   ...
											   $("#shangjia").val($("#shangjia option:eq("+shangjiaidselectedindex+")").val());
												...
												<div style='display:none;' class="col-sm-9">
                                                    <select id='shangjiaid' onchange="shangjiachange(this)"name="shanghuid" class="form-control"><c:if test="${ !empty shangjiaall}">
							<c:forEach items="${ shangjiaall}" var="item">
