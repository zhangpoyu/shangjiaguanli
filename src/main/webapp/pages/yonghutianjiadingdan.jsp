						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="yonghutianjiadingdanact.action" enctype="multipart/form-data">
										<div class="card-body">
										...
										function GetQueryString(name) { 
											...
											　　$("#shangpingid").val(shangpingid);
											   ...
											   $("#shangping").attr("disabled","disabled");
												...
												<div class="col-sm-9">
													<input name="shijian" id="shijian" readonly="readonly" type="text" class="form-control" placeholder=" ">
													<script>
												document.getElementById("shijian").value = new Date().toLocaleString();
												</script>
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">订单状态</label>
												<div class="col-sm-9">
													<input name="zhuangtai" type="text" value="已下单" readonly="readonly" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
...
<script>
										...
										<div class="card-footer p-4">
											<button class="btn btn-success" type="button" onclick="showzhifu()">添加</button>
              <script>
              	function showzhifu(){
            		$('#myModal').modal('show')
            	}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align: center;">
        <img src="resource/zhifu/zhifu.png" style="width: 300px;height: 300px;">
      </div>
