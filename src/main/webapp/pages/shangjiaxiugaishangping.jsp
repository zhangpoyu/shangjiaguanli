						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="shangjiaxiugaishangpingact.action" enctype="multipart/form-data">
										<div class="card-body">
...
<script>
                                           ...
                                           $("#leixingid").val($("#leixingid option:eq("+select.selectedIndex+")").val());                                                	}
												...
												<div class="col-sm-9">
													<input name="jiage" value="${shangping.jiage}" type="number" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">数量</label>
												<div class="col-sm-9">
													<input name="shuliang" value="${shangping.shuliang}" type="number" class="form-control" placeholder=" ">
												</div>
