			...
			<div class="container_full">
				...
				<main class="content_wrapper">
                    ...
                    <c:if test="${ !empty pingjiaall}">
                      ...
                      </td><td>                        ${item.shangping }
                      </td><td>                        ${item.shangpingid }
                      </td><td>
                          <a class="table-actions" href="shangpingxiangqing.action?id=${item.shangpingid}">查看</a> <a class="table-actions" href="yonghushanchupingjia.action?id=${item.id}">删除</a>
                      </td>                    </tr>
							</c:forEach>
				</c:if>
                  </tbody>
