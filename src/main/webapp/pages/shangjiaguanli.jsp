			...
			<div class="container_full">
				...
				<main class="content_wrapper">
                    ...
                    <c:if test="${ !empty shangjiaall}">
                      ...
                      </td><td>                        ${item.shangjiadizhi }
                      </td><td>                        ${item.lianxifangshi }
                      </td><td>                        ${item.shenhe }
                      </td><td>
                          <a class="table-actions" href="xiugaishangjia.action?id=${item.id}">修改</a> <a class="table-actions" href="shanchushangjia.action?id=${item.id}">删除</a>
                      </td>                    </tr>
							</c:forEach>
				</c:if>
                  </tbody>
