						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="tianjiashangjiaact.action" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-sm-9">
													<input name="shangjiadizhi" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												...
												<div class="col-sm-9">
													<input name="shenhe" type="text" class="form-control" placeholder=" ">
												</div>
											</div>
										</div>
