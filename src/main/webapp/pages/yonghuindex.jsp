						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="yonghuxiugaigerenxinxiact.action" enctype="multipart/form-data">
										<div class="card-body">
...
<div class="form-group row">
												...
												<div class="col-sm-9">
													<input value="${sessionScope.userinfo.xingbie}" name="xingbie" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">年龄</label>
												<div class="col-sm-9">
													<input value="${sessionScope.userinfo.nianling}" name="nianling" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">收货地址</label>
												<div class="col-sm-9">
													<input value="${sessionScope.userinfo.shouhuodizhi}" name="shouhuodizhi" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
