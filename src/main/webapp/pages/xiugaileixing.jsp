						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="xiugaileixingact.action" enctype="multipart/form-data">
										<div class="card-body">
											<input name='id' style='display:none;' value="${leixing.id}"><div class="form-group row">
												<label class="col-sm-3 col-form-label">类型</label>
												<div class="col-sm-9">
													<input name="leixing" value="${leixing.leixing}" type="text" class="form-control" placeholder=" ">
												</div>
											</div>
										</div>
