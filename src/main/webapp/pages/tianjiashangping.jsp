						...
						<div class="row">
							<div class=" col-md-6">
								<div class="card card-shadow mb-4">
									...
									<form method="post" action="tianjiashangpingact.action" enctype="multipart/form-data">
										<div class="card-body">
                                           ...
                                           $("#leixingid").val($("#leixingid option:eq("+select.selectedIndex+")").val());                                                	}
											...
											　　$("#leixingid").val(leixingid);
											   ...
											   $("#leixing").val($("#leixing option:eq("+leixingidselectedindex+")").val());
												...
												<div class="col-sm-9">
													<input name="shangjia" type="text" class="form-control" placeholder=" ">
												</div>
												...
												<div style='display:none;' class="col-sm-9">
													<input name="shangjiaid" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">图片</label>
												<div class="col-sm-9">
													<input name="tupian" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												...
												<div class="col-sm-9">
													<input name="xdcs" type="text" class="form-control" placeholder=" ">
												</div>
											</div><div class="form-group row">
												<label class="col-sm-3 col-form-label">浏览次数</label>
												<div class="col-sm-9">
													<input name="llcs" type="text" class="form-control" placeholder=" ">
												</div>
											</div>
										</div>
