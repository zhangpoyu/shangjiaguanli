		...
		<div class="wrapper">
			...
			<div class="container_full">
				...
				<main class="content_wrapper">
                    ...
                    <c:if test="${ !empty leixingall}">
							<c:forEach items="${ leixingall}" var="item">
							
								<tr><td>                        ${item.leixing }
                      </td><td>
                          <a class="table-actions" href="xiugaileixing.action?id=${item.id}">修改</a> <a class="table-actions" href="shanchuleixing.action?id=${item.id}">删除</a>
                      </td>                    </tr>
							</c:forEach>
				</c:if>
                  </tbody>
