    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="page-heading">精选商家，质量保证 </h2><!--/.page-heading-->
            </div><!--/.col-md-12-->
        </div><!--/.row-->
    </div><!--/.container-->
...
<div class="container">
	<div style="padding: 20px;">
						<form action="sousuoshangjia.action" method="post">
                    ...
                    <div class="menu-item-two">
                       <%--  <div class="image-area">
                            <a href="sousuoshangping.action?shangjiaid=${item.id}">
                                <img src="resource/uploads/${item.id }" alt="menu-item" style="width: 265px;height: 193px;">
                            </a>
                        </div> --%>
                        <div class="menu-content text-center">
                            <h5 class="menu-title">
                                <a href="sousuoshangping.action?shangjiaid=${item.id}">${item.shangjiadizhi }</a>
                            </h5>
                            <h5 class="menu-title">
                                <a href="sousuoshangping.action?shangjiaid=${item.id}">${item.lianxifangshi }</a>
                            </h5>
                            <h5 class="menu-title">
                                <a href="sousuoshangping.action?shangjiaid=${item.id}">${item.mingzi }</a>
                            </h5>
                        </div>
                    </div>
                </div>
